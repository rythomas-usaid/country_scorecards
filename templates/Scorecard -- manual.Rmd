...
if(ou_name == "Group Target") {
  # group_target_ous <- filter(pt_dat, is_group == TRUE ) %>% distinct(ro, ou)
  # make_budget_plot(budget = budget, ou_name = group_target_ous)
...
```{r}
knitr::include_graphics(paste0("../", mapfile))
