...
ftf_programs <- data.frame(
  ...
  program = c("Afghanistan","Afghanistan",
              ...
              "Bureau for Resilience and Food Security","Burkina Faso",
              ...
              "Caribbean Development Program","Central African Republic",
              ...
              "Dominican Republic","East Africa",
              ...
              "Regional Center for South Africa","Republic of the Congo","Rwanda",
              "Rwanda","Rwanda","Rwanda","Rwanda",
              "Sahel Regional Program","Sahel Regional Program",
              ...
              "USAID Regional Development Mission/Asia","USDA","USDA","USDA","Uzbekistan",
              "Uzbekistan","Vanuatu","Venezuela","Vietnam","Vietnam",
              "Vietnam","West Africa Regional Program","West Bank",
              "Yemen","Zambia","Zambia","Zambia","Zambia",
              "Zambia","Zimbabwe","Zimbabwe","Zimbabwe")
) %>% left_join(tibble(program = c("Afghanistan",
                        "Bangladesh",
                        ...
                        "Zambia",
                        "Zimbabwe")
) %>% mutate(target_program = program)) %>% as_tibble()
